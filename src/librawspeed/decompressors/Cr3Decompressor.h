...
#include "decompressors/AbstractBmffDecompressor.h" // for AbstractLJpegDe...
...
public:
  ...
  Cr3Slicing(uint16_t numSlices_, uint16_t sliceWidth_,
...
class Cr3Decompressor final : public AbstractBmffDecompressor
{
  Cr3Slicing slicing;
...
public:
  Cr3Decompressor(const ByteStream& bs, const RawImage& img);
  void decode(const Cr3Slicing& slicing);
};
